    ...
    option = {
        ...
        xAxis: [
            {
                ...
                type: 'category',
                // 使用 data 中的数据设为刻度文字
                data: ['上海', '广州', '北京', '广东', '安徽', '内蒙古', '山西', '东北', '杭州', '厦门', '山东', '成都', '重庆'],
                // 刻度设置
                axisTick: {
                    // true意思：图形在刻度中间
                    // false意思：图形在刻度之间
        ...
        series: [

            {
                ...
                barWidth: '60%',
                // 数据
                data: [2165, 1963, 1760, 1560, 1400, 1987, 765, 956, 931, 756, 604, 489, 241]
            }
        ]
    };
...
(function () {
    var data = {
        day365: { orders: '745', amount: '731' },
        day90: { orders: '32%', amount: '30%' },
        day30: { orders: '65kg', amount: '78kg' },
        day1: { orders: '24°C', amount: '21°C' }
    }
    //点击事件
